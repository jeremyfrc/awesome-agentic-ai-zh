...
- 🔌 **接 Notion / Obsidian / Excel / GitHub 等日常工具** → [RESOURCES.md §接日常工具](RESOURCES.md#接日常工具常用-mcp-server--skill) 或完整 57 條目錄 [`resources/mcp-skills-catalog.md`](resources/mcp-skills-catalog.md)
